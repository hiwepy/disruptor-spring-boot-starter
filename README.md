...
| JDK | `17` |
| Coordinates | `io.github.easy4j:disruptor-spring-boot-starter:3.4.x.20260527-SNAPSHOT` |
...
| `DisruptorTemplate` bean | ✅ Stable | Auto-registered via DisruptorAutoConfiguration |
