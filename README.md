...
> **Current Version**：`1.0.4-SNAPSHOT`<br>
> **JDK Baseline**：`17`<br>
...
| JDK | `17` |
| Coordinates | `io.github.easy4j:disruptor-spring-boot-starter:1.0.4-SNAPSHOT` |
...
| `ThreadFactory` bean | ✅ Stable | Auto-registered via DisruptorAutoConfiguration, RingBufferAutoConfiguration |
