...
| JDK | `17` |
| 坐标 | `io.github.easy4j:disruptor-spring-boot-starter:1.0.4-SNAPSHOT` |
| 配置前缀 | `disruptor` |
...
| `ThreadFactory` Bean | ✅ 稳定 | 通过 DisruptorAutoConfiguration, RingBufferAutoConfiguration 自动注册 |
